...
var kataVolumeCommand = cli.Command{
	Name:        "direct-volume",
	Usage:       "directly assign a volume to Kata Container to manage",
...
var addCommand = cli.Command{
	Name:  "add",
	Usage: "add a direct assigned block volume device to the Kata Container runtime",
	Flags: []cli.Flag{
		cli.StringFlag{
			Name:        "volume-path",
...
var removeCommand = cli.Command{
	Name:  "remove",
	Usage: "remove a direct assigned block volume device from the Kata Container runtime",
	Flags: []cli.Flag{
		cli.StringFlag{
			Name:        "volume-path",
			Usage:       "the target volume path the volume is published to",
